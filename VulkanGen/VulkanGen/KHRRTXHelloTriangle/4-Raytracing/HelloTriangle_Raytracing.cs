...
namespace KHRRTXHelloTriangle
{
    public unsafe partial class HelloTriangle
    {
        ...
        private AccelerationMemory CreateAccelerationScratchBuffer(VkAccelerationStructureKHR acceleration, VkAccelerationStructureMemoryRequirementsTypeKHR type)
        {
            ...
            bufferInfo.usage = VkBufferUsageFlagBits.VK_BUFFER_USAGE_RAY_TRACING_BIT_KHR | VkBufferUsageFlagBits.VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT;
            ...
            memAllocFlagsInfo.flags = VkMemoryAllocateFlagBits.VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT; // TODO Remove _KHR
            ...
            memAllocInfo.memoryTypeIndex = this.FindMemoryType(allocationMemoryBits, VkMemoryPropertyFlagBits.VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
        ...
        AccelerationMemory CreateMappedBuffer<T>(T[] srcData, uint byteLength)
        {
            ...
            memAllocFlagsInfo.sType = VkStructureType.VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO;
            memAllocFlagsInfo.pNext = null;
            memAllocFlagsInfo.flags = VkMemoryAllocateFlagBits.VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT; // TODO VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR
            memAllocFlagsInfo.deviceMask = 0;
            ...
            memAllocInfo.memoryTypeIndex = this.FindMemoryType(memoryRequirements.memoryTypeBits, VkMemoryPropertyFlagBits.VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VkMemoryPropertyFlagBits.VK_MEMORY_PROPERTY_HOST_COHERENT_BIT);
            Helpers.CheckErrors(VulkanNative.vkAllocateMemory(device, &memAllocInfo, null, &outValue.memory));
                               ...
                               ref VkImageSubresourceRange subresourceRange)
        {
            ...
            VulkanNative.vkCmdPipelineBarrier(commandBuffer, VkPipelineStageFlagBits.VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VkPipelineStageFlagBits.VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, 0, 0, null, 0, null, 1, &imageMemoryBarrier);
        }
        ...
        private void CreateCommandBuffers()
        {
            ...
            for (uint ii = 0; ii < this.commandBuffers.Length; ++ii)
            {
                ...
                this.InsertCommandImageBarrier(commandBuffer, offscreenBuffer, 0, VkAccessFlagBits.VK_ACCESS_SHADER_WRITE_BIT,
                ...
                this.InsertCommandImageBarrier(commandBuffer, swapchainImage, 0, VkAccessFlagBits.VK_ACCESS_TRANSFER_WRITE_BIT,
                                          VkImageLayout.VK_IMAGE_LAYOUT_UNDEFINED,
                ...
                this.InsertCommandImageBarrier(commandBuffer, offscreenBuffer, VkAccessFlagBits.VK_ACCESS_SHADER_WRITE_BIT,
